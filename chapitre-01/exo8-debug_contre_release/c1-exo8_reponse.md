...
## Construisez le même projet dans les deux configurations et comparez la taille du binaire produit et le temps de construction.

* **Mode Debug :**
  * **Commande :** jenga build --project MonEssai --config Debug
  * **Temps de construction :** 0.03s
  * **Taille du binaire (`MonEssai.exe`) :** 139ko
  * **Retour du terminal :** **PS C:\Users\Mastermein\Desktop\Teuguis\Nkentseu> jenga build --project MonEssai --config Debug
...
* **Mode Release :**
  * **Commande :** jenga build --project MonEssai --config Release
  * **Temps de construction :** 0.72s
  * **Taille du binaire (`MonEssai.exe`) :** 139ko
  * **Retour du terminal :** **PS C:\Users\Mastermein\Desktop\Teuguis\Nkentseu>
