...
PS C:\Users\Mastermein\Desktop\clone A\depot-d-essaie> git commit -m "modifcatons de l'utilisateur 02 "
[main a5c4470] modifcatons de l'utilisateur 02
 1 file changed, 1 insertion(+), 1 deletion(-)
...
Unpacking objects: 100% (4/4), 336 bytes | 8.00 KiB/s, done.
From https://github.com/mastermein/depot-d-essaie
 * branch            main       -> FETCH_HEAD
   78de0f1..b66620c  main       -> origin/main
...
Writing objects: 100% (17/17), 1.50 KiB | 256.00 KiB/s, done.
Total 17 (delta 5), reused 0 (delta 0), pack-reused 0 (from 0)
remote: Resolving deltas: 100% (5/5), completed with 1 local object.
To https://github.com/mastermein/depot-d-essaie.git
   b66620c..5561224  main -> main`

## etat final de main.cpp sur github
 ...
 * **commentaire**
   * `le fichier main.cpp porte les modifications des deux utilisateurs , ce qui Montre que git assemble les deux sans rien demander.`
